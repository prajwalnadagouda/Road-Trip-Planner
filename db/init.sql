...
CREATE TABLE events (event_id INT PRIMARY KEY, event_date DATE, event_performer VARCHAR(255), event_type VARCHAR(255), event_venue VARCHAR(255), latitude FLOAT(10, 6),longitude FLOAT(10, 6), event_lowest_price INT, event_highest_price INT);
