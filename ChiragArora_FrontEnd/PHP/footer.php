...
<body>
  ...
  <footer class="footer-distributed">
    ...
    <div class="footer-icons">
      ...
      <a href="https://github.com/chirag-arora01/CMPE-272-Project"><i class="fab fa-github"></i></a>
    </div>  
    <hr>
    <p class="footer-company-name"><strong>DestinationExplorer &copy; 2022</strong></p>
  </footer>
</body>
</html>