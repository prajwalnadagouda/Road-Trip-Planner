...
def display(l1,l2,l3,l4):
    ...
    mycursor.execute("SELECT station_name,latitude,longitude FROM fuelstations WHERE latitude > %s AND latitude < %s AND longitude > %s AND longitude < %s LIMIT 10",(l1,l2,l3,l4))
