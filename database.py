...
class database:
    ...
    def update_database(self): 
        events = requests.get('https://api.seatgeek.com/2/events?per_page=5&venue.state=CA&client_id=MzAxNTQ4MTV8MTY2NzY4MzY2Ni41NjMyMjg4')
        ...
        for event in events:
            ...
            print(event_id, event_type, event_venue, event_lat ,event_lon, event_lowest_price, event_highest_price)
